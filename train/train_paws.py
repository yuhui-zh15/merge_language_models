...
def train(model_name: str, pretrained: bool, number_epochs: int):
    ...
    def preprocess_function(examples, verbose: bool = False):
        ...
        for i in range(len(examples["sentence1"])):
            ...
            processed_sentence = f"This does suggest that {sentence_1} and {sentence_2} are {'similar' if label == 1 else 'different'}."
    ...
    training_args = TrainingArguments(
        output_dir=f"dumps/finetuned_{model_name}_pretrained{pretrained}_PAWS_epochs{number_epochs}",
